...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <?php else : ?>
            <li
                class="<?php echo $this->uri->uri_string() == 'dashboard' || $this->uri->uri_string() == '' ? 'active' : ''; ?>">
                <a class="nav-link" href="<?php echo base_url(); ?>dashboard"><i class="fas fa-home"></i>
            ...
            <li class="<?php echo $this->uri->uri_string() == 'admin-pengajuan' || $this->uri->uri_string() == 'admin-pengajuan/detail' ? 'active' : ''; ?>">
                <a href="<?php echo base_url(); ?>admin-pengajuan"><i class="fas fa-th-large"></i>
                    <span>Permohonan</span>
                </a>
            </li>


            <li class="<?php echo $this->uri->uri_string() == 'admin-pemohon'
             || $this->uri->uri_string() == 'admin-pemohon/validasi_pemohon' ? 'active' : ''; ?>">
                <a href="<?php echo base_url(); ?>admin-pemohon"><i class="fas fa-exclamation-triangle"></i>
                    <span>
                        Pemohon
                    </span>
                </a>
            ...
            <li class="">
                <a href="<?php echo base_url(); ?>blankspot"><i class="fas fa-exclamation-triangle"></i> <span>
                        Blankspot Area</span></a>
            </li>
            <!-- END BANTUAN BAKTI -->
        ...
        <ul class="dropdown-menu">
            ...
            <li
                class="<?php echo $this->uri->uri_string() == 'perusahaan' || $this->uri->uri_string() == 'syarat' ? 'active dropdown' : ''; ?>">
