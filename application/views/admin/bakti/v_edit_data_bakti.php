                ...
                <div class="col-md-4 col-sm-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" class="form-control" value="<?= $dbakti->id_menara_bakti; ?>" name="id_menara_bakti" id="id_menara_bakti" required>
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            <label for="latitude">Latitude</label>
                                            <input type="text" class="form-control" value="<?= $dbakti->latitude; ?>" name="latitude" id="latitude" required>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?= $dbakti->longitude; ?>" name="longitude" id="longitude" required>
                                            <div class="invalid-feedback">
                                                Field tidak boleh kosong
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="namasite">Nama Site / Lokasi</label>
                                            <input type="text" class="form-control" value="<?= $dbakti->nama_site_lokasi; ?>" name="nama_site_lokasi" id="nama_site_lokasi" required>
                                            <div class="invalid-feedback">
                                                Field tidak boleh kosong
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kategori" id="kategori" style="width: 100%;" required>
                                                <option <?=($dbakti->kategori === '1') ? 'selected' : ''; ?> value="1">Sekolah</option>
                                                <option <?=($dbakti->kategori === '2') ? 'selected' : ''; ?> value="2">Desa</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" onchange="getDesaByKecamatan()" name="id_kecamatan" id="id_kecamatan" style="width: 100%;" required>
                                                <option value="<?= $dbakti->id_kecamatan; ?>" selected><?= $dbakti->nama_kecamatan; ?></option>
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="id_desa" onchange="checkDesa()" id="id_desa" style="width: 100%;">
                                                <!-- <option>---</option> -->
                                                <option value="<?= $dbakti->id_desa; ?>" selected><?= $dbakti->nama_desa; ?></option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="alamat" id="alamat" value="<?= $dbakti->alamat; ?>"><?= $dbakti->alamat; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="alamat">Tahun Berdiri</label>
                                            <input type="number" class="form-control" value="<?= $dbakti->tahun_berdiri; ?>" name="tahun_berdiri" id="tahun_berdiri">
                                        </div>
                                    </div>
...
<script>
    ...
    function updateDataBakti(obj) {
        $.ajax({
            url: base_url + 'bakti/update_data_bakti',
            method: "POST",
            data: obj,
            async: true,
            dataType: 'json',
