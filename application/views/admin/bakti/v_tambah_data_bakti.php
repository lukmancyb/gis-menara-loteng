                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_site_lokasi" id="nama_site_lokasi" required>
                                            <div class="invalid-feedback">
                                                Field tidak boleh kosong
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="tahun_berdiri" id="tahun_berdiri">
                                        </div>
                                    </div>
...
<script>
    ...
    function simpanDataTower(obj) {
        $.ajax({
            url: base_url + 'bakti/simpan_data_bakti',
            method: "POST",
            data: obj,
            async: true,
            dataType: 'json',
